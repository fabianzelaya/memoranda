...
public class AgendaGenerator {
	...
	static String HEADER =
			"<html><head><title></title>\n"
					...
					+ "    h1 {font:20pt sans-serif; background-color:#ADD8E6; margin-top:0}\n"
...
=======*/
	...
	static String generateStickers(CalendarDate date) {
		...
		String iurl2 =
				...
				.toExternalForm();
		 String s = "<hr><hr><table border=\"0\" cellpadding=\"0\" width=\"100%\"><tr><td><a href=\"memoranda:importstickers\"><b>"+Local.getString("IMPORTAR ANOTACION")+"</b></a></td><td><a href=\"memoranda:exportstickerst\"><b>"+Local.getString("EXPORTAR ANOTACION .TXT")+"</b></a><td><a href=\"memoranda:exportstickersh\"><b>"+Local.getString("EXPORTAR ANOTACION COMO .HTML")+"</b></a></td></tr></table>"
